 ...
 *
 * $Id: versekey.h,v 1.2.2.3 2000/04/10 20:53:11 scribe Exp $
 *
...
*/
	...
	static ListKey ParseVerseList(const char *buf, const char *defaultKey = "Genesis 1:1", bool expandRange = false);
